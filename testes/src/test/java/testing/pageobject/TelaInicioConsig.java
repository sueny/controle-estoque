...
public class TelaInicioConsig {
    ...
    public void buscarCliente() {
        driver.findElement(By.name("nameCliente")).sendKeys("d");
        driver.findElement(By.name("buscarcliente")).click();
    }
    ...
    public int getQntValue() {
        String qnt = driver.findElement(By.name("qnt")).getAttribute("value");
        return Integer.parseInt(qnt);
    }
    
    public void buscarProduto() {
        driver.findElement(By.name("palavraChaveBusca")).sendKeys("p");
        driver.findElement(By.name("buscarproduto")).click();
    }
