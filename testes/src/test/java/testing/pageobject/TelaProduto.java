...
public class TelaProduto extends TelaSistema {
    ...
    public void setSkuProduto(String str) {
        driver.findElement(By.name("skuProduto")).sendKeys(str);
    }
...
//    }
    ...
    public boolean isJaFoiSelecionadaDisplayed() {
        String text = "Já foi selecionada";
        List<WebElement> list = driver.findElements(Utils.byText(text));
        boolean displayed = list.size() > 0 && list.get(0).isDisplayed();
        if (displayed) {
            driver.findElement(By.className("btn-close-toast")).click();
    ...
    public void limparInputs() {
        driver.findElement(By.name("skuProduto")).clear();
        driver.findElement(By.name("nomeProduto")).clear();
        driver.findElement(By.name("variationProduto")).clear();
    }
