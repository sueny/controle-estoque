...
public class TelaCliente extends TelaSistema {
    ...
    public void preencheForm(boolean validData) {
        ...
        driver.findElement(By.name("rgClient")).clear();
        driver.findElement(By.name("phoneNumberClient")).clear();
        driver.findElement(By.name("cellNumberClient")).clear();
        driver.findElement(By.name("addressClient")).clear();
        driver.findElement(By.name("neighborhoodClient")).clear();
        driver.findElement(By.name("numberClient")).clear();
        driver.findElement(By.name("cityClient")).clear();
        driver.findElement(By.name("cepClient")).clear();
        driver.findElement(By.name("emailClient")).clear();
        driver.findElement(By.name("obsClient")).clear();
    ...
    public boolean isDeleteSuccessMessageDisplayed() {
        return super.checaEFechaMensage("Removido");
    }
